...
class TerminUpdateHandlerFactory extends AbstractBaseHandlerFactory
{
    public function __invoke(ContainerInterface $container): TerminUpdateHandler
    {
        $page = new TerminUpdateHandler();
