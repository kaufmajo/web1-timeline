...
class MediaUpdateHandlerFactory extends AbstractBaseHandlerFactory
{
    public function __invoke(ContainerInterface $container): MediaUpdateHandler
    {
        $page = new MediaUpdateHandler();
